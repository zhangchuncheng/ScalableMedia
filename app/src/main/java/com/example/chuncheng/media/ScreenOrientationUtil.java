...
/**
 * Description:使用加速传感器或和OrientationEventListener做横竖屏切换
 * @author: zhangchangan 
 * @date:  2016/5/6 13:18
 */
...
public class ScreenOrientationUtil {
	...
	public boolean isPortrait(){
		return mOrientation == ActivityInfo.SCREEN_ORIENTATION_PORTRAIT || mOrientation == ActivityInfo.SCREEN_ORIENTATION_REVERSE_PORTRAIT;
	}
